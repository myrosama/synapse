        ...
        >
            ...
            {transcript && (
                <Card>
                    ...
                    <CardContent>
                        <p className="text-slate-300 leading-relaxed">{transcript || 'Listening...'}</p>
                    </CardContent>
                </Card>
            )}
            ...
            {feedback && (
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                >
                    <Card className="bg-gradient-to-r from-cyan-900/10 to-violet-900/10">
                        <CardHeader>
                            <CardTitle className="flex items-center justify-between">
                                ...
                                <div className={`text-2xl font-bold ${feedback.score >= 70 ? 'text-green-400' :
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div>
                                <p className="text-sm text-slate-400 mb-2 flex items-center gap-2">
                                    ...
                                    Keywords Found ({feedback.keywordsFound.length}/{prompt.keywords.length})
                                </p>
                                <div className="flex flex-wrap gap-2">
                                    {feedback.keywordsFound.map(kw => (
                                        <span key={kw} className="text-xs px-2 py-1 rounded-full bg-green-500/20 text-green-400">
                                            ✓ {kw}
                                        </span>
                                    ))}
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {feedback.keywordsMissing.map(kw => (
                                            <span key={kw} className="text-xs px-2 py-1 rounded-full bg-red-500/20 text-red-400">
                                                {kw}
                                            </span>
                                        ))}
                                    </div>
